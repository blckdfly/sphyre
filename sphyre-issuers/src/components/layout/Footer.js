    ...
    <footer className="bg-white border-t border-dark-100">
      <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          <button type="button" className="text-dark-200 hover:text-dark-300">
            <span className="sr-only">Help</span>
            <span className="text-sm text-dark-300 hover:text-dark-500">Help</span>
          </button>
          <button type="button" className="text-dark-200 hover:text-dark-300">
            <span className="sr-only">Privacy</span>
            <span className="text-sm text-dark-300 hover:text-dark-500">Privacy</span>
          </button>
          <button type="button" className="text-dark-200 hover:text-dark-300">
            <span className="sr-only">Terms</span>
            <span className="text-sm text-dark-300 hover:text-dark-500">Terms</span>
          </button>
        </div>
