...
export default function RecoveryPage() {
  ...
  const [step, setStep] = useState('seedphrase'); // seedphrase | setpin
  ...
  const handleVerifySeedPhrase = () => {
    ...
    if (!issuerAuthService.validateSeedPhrase(seedPhrase)) {
  ...
  const handleRecoverWithNewPin = async () => {
    ...
    try {
      const seedPhrase = seedWords.join(' ');
      await issuerAuthService.recoverWithSeedPhrase(seedPhrase, newPin);
      navigate('/');
    } catch (error) {
      console.error('Recovery error:', error);
      setError(error.message || 'Recovery failed. Please check your seed phrase.');
      setLoading(false);
    }
  };
            ...
            <div style={styles.card}>
              ...
              <div style={styles.actions}>
                <button
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(0, 5, 255, 0.1)'; }}
              ...
              <button
                ...
                onMouseEnter={(e) => { if (seedWords.filter(w => w).length === 12) e.currentTarget.style.transform = 'translateY(-2px)'; }}
          ...
          <div style={styles.card}>
            ...
            <div style={styles.inputGroup}>
              ...
              <div style={styles.hint}>
                Choose a 6-digit PIN that you'll remember. This will replace your previous PIN.
              </div>
            </div>
            ...
            <button
              ...
              onMouseEnter={(e) => { if (!loading && newPin.length === 6 && confirmPin.length === 6) e.currentTarget.style.transform = 'translateY(-2px)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; }}
            >
              {loading ? (
                <>
