...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (issuerAuthService.isSessionAuthenticated()) {
      navigate('/dashboard');
      return;
    }
  ...
  const handleLogin = async (e) => {
    ...
    try {
      await issuerAuthService.loginWithPIN(pin);
      navigate('/dashboard');
    } catch (error) {
        ...
        <div style={styles.wrapper}>
          ...
          <div style={styles.header}>
            ...
            <div style={styles.issuerInfo}>
              <div style={styles.issuerName}>{issuerInfo.name}</div>
              <div style={styles.issuerDomain}>{issuerInfo.domain}</div>
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                ...
                onMouseEnter={(e) => { if (pin.length >= 4 && !loading) e.currentTarget.style.transform = 'translateY(-2px)'; }}
