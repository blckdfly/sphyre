...
const TermsOfUsePage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            {/* Content */}
            <div className="flex-1 bg-white px-4 pt-6 pb-6">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold text-dark-500 mb-4">Terms of Use</h2>

                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">1. Acceptance of Terms</h3>
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">2. Use of the Service</h3>
                            ...
                            <ul className="list-disc pl-5 text-sm text-dark-500 space-y-1">
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">3. Privacy and Data</h3>
                            <p className="text-dark-500 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">4. Modifications to Service</h3>
                            <p className="text-dark-500 text-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">5. Limitation of Liability</h3>
                            <p className="text-dark-500 text-sm">
