    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <div className="flex-1 bg-white px-4 pt-6 pb-6">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold text-dark-500 mb-4">Privacy Policy</h2>

                    <div className="space-y-6">
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">1. Information We Collect</h3>
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">2. How We Use Your Information</h3>
                            <p className="text-dark-500 text-sm mb-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">3. Data Storage and Security</h3>
                        ...
                        <div>
                            <h3 className="font-semibold text-dark-500 mb-2">4. Your Rights</h3>
                            <p className="text-dark-500 text-sm">
