...
export default function SeedPhraseSetup() {
  ...
  useEffect(() => {
    try {
      ...
      const phrase = verifierAuthService.generateNewSeedPhrase();
      ...
      setInitError(err instanceof Error ? err.message : 'Failed to initialize seed phrase setup');
    }
  }, [router]);
          ...
          <div style={{...styles.wrapper, maxWidth: '500px'}}>
            <div style={styles.card}>
              <div style={{textAlign: 'center'}}>
                ...
                <button onClick={() => router.push('/onboarding')} style={styles.button}>
                  Back to Onboarding
                </button>
              </div>
            </div>
          ...
          <div style={styles.wrapper}>
            ...
            <div style={styles.header}>
              <div style={styles.brandContainer}>
                ...
                <div style={styles.brandSubtitle}>Verifier Platform</div>
              </div>
            ...
            <div style={styles.card}>
              ...
              <button
                ...
                onMouseEnter={(e) => { if (showSeed) (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-2px)'; }}
